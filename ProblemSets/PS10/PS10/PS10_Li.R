...
PRED.Tree <- setHyperPars(learner=trees, par.vals = TUNE.Tree$x)
...
SAMPLE.Tree  <- resample(learner = PRED.Tree, task = task.highearner, resampling = resampleStrat, measures=list(gmean))
